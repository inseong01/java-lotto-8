...
5. 양 만큼 사용자의 로또 번호를 생성한다. 

6. 사용자의 로또를 생성한다. 
   - 로또 번호를 검증한다. 

7. 사용자 로또 개수 만큼 로또 번호를 출력한다.
  - "[ 로또 번호 6개 구성 ]"
...
9. 당첨 로또를 생성한다.
  - 로또 번호를 검증한다. (숫자인지, 6개인지)

10. 보너스 번호를 입력한다.
  - 숫자 입력

11. 보너스 번호를 생성한다.
  - 번호를 검증한다. (숫자인지, 당첨 번호와 중복되는지)
...
5. 사용자 로또 번호를 출력한다.
6. 사용자는 당첨 번호를 입력한다.
7. 로또를 생성할 때 번호를 검증한다. (생성 오류 발생)
8. 사용자는 다시 당첨 번호를 입력한다.
```
...
7. 당첨 로또를 생성한다.
8. 사용자는 보너스 번호를 입력한다.
9. 보너스 번호 생성할 때 번호를 검증한다. (생성 오류 발생)
10. 사용자는 다시 보너스 번호를 입력한다.
```
...
- 입력 검증 (문자열 - 현금, 로또 번호, 보너스 번호 숫자 변환 이전)
...
1. 상품 금액(1,000)으로 나눠서 떨어지지 않는 경우
